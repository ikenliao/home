...
const add_id = "qsltyupdvvilr8up"; // app_id
const app_secret = "c2ZYb3FKTnFad3FjQm5YMEdPMU16Zz09"; // app_secret
const key = "1a59c67732004089ac7a7b69ccbb8e3a" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Hey.");
        $("#change1").html("欢迎光临&nbsp;Ken Liao&nbsp;的个人主页");
    }
});
